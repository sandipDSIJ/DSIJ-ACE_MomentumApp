...
public class RatingBottomSheetDialogFragment extends BottomSheetDialogFragment {
    ...
    private MyTextView tvLabelMessage;
    private TextInputLayout tilComments;
    private MyEditText etComments;
    ...
    private void findViews(View rootView) {
        ...
        tvLabelMessage = (MyTextView) rootView.findViewById(R.id.tvLabelMessage);
        tilComments = (TextInputLayout) rootView.findViewById(R.id.tilComments);
        etComments = (MyEditText) rootView.findViewById(R.id.etComments);
