package in.dsij.acemomentum.dialog;
...
public class ReportDialogFragment extends DialogFragment {
    ...
    private MyAutoCompleteTextView etEmail;
    private MyAutoCompleteTextView etPhone;
    private MyAutoCompleteTextView etDescription;
    private MyTextView tvBtnCancel;
    private MyTextView tvBtnOk;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        tvLabel = (MyTextView) rootView.findViewById(R.id.tvLabel);
        etEmail = (MyAutoCompleteTextView) rootView.findViewById(R.id.etEmail);
        etPhone = (MyAutoCompleteTextView) rootView.findViewById(R.id.etPhone);
        etDescription = (MyAutoCompleteTextView) rootView.findViewById(R.id.etDescription);
        tvBtnCancel = (MyTextView) rootView.findViewById(R.id.tvBtnCancel);
        tvBtnOk = (MyTextView) rootView.findViewById(R.id.tvBtnOk);
